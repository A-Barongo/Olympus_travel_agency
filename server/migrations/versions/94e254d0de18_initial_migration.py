...
Revision ID: 94e254d0de18
Revises: 
Create Date: 2025-06-23 23:22:53.759844
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['destination_id'], ['destinations.id'], name=op.f('fk_bookings_destination_id_destinations')),
